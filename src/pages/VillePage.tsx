...
import saintFonsHero from '../assets/saint-fons-hero.jpg';
import givorsHero from '../assets/givors-hero.jpg';
import genasHero from '../assets/genas-hero.jpg';
import saintMartinDheresHero from '../assets/saint-martin-dheres-hero.jpg';
import echirollesHero from '../assets/echirolles-hero.jpg';
import fontaineHero from '../assets/fontaine-hero.jpg';
import voironHero from '../assets/voiron-hero.jpg';
import saintEgreveHero from '../assets/saint-egreve-hero.jpg';
import seyssinetParisetHero from '../assets/seyssinet-pariset-hero.jpg';
import villefontaineHero from '../assets/villefontaine-hero.jpg';
import lisleDabeauHero from '../assets/lisle-dabeau-hero.jpg';
import sassenageHero from '../assets/sassenage-hero.jpg';
import crollesHero from '../assets/crolles-hero.jpg';
import laMotteServolexHero from '../assets/la-motte-servolex-hero.jpg';
import bourgSaintMauriceHero from '../assets/bourg-saint-maurice-hero.jpg';
import albertvilleHero from '../assets/albertville-hero.jpg';
import saintJeanDeMaurienneHero from '../assets/saint-jean-de-maurienne-hero.jpg';
import ugineHero from '../assets/ugine-hero.jpg';
import modaneHero from '../assets/modane-hero.jpg';
import thononLesBainsHero from '../assets/thonon-les-bains-hero.jpg';
import gaillardHero from '../assets/gaillard-hero.jpg';
import seynodHero from '../assets/seynod-hero.jpg';
...
const VillePage = () => {
  ...
  const getHeroImage = (citySlug: string) => {
    switch(citySlug) {
      ...
      case 'saint-fons': return saintFonsHero;
      case 'givors': return givorsHero;
      case 'genas': return genasHero;
      case 'saint-martin-dheres': return saintMartinDheresHero;
      case 'echirolles': return echirollesHero;
      case 'fontaine': return fontaineHero;
      case 'voiron': return voironHero;
      case 'saint-egreve': return saintEgreveHero;
      case 'seyssinet-pariset': return seyssinetParisetHero;
      case 'villefontaine': return villefontaineHero;
      case 'lisle-dabeau': return lisleDabeauHero;
      case 'sassenage': return sassenageHero;
      case 'crolles': return crollesHero;
      case 'la-motte-servolex': return laMotteServolexHero;
      case 'bourg-saint-maurice': return bourgSaintMauriceHero;
      case 'albertville': return albertvilleHero;
      case 'saint-jean-de-maurienne': return saintJeanDeMaurienneHero;
      case 'ugine': return ugineHero;
      case 'modane': return modaneHero;
      case 'thonon-les-bains': return thononLesBainsHero;
      case 'gaillard': return gaillardHero;
      case 'seynod': return seynodHero;
